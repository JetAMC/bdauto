...
// Sending
mail('info@bdauto.lv', 'Заявка с Landing Page полировка фар RU', $name . "\n" . $kod . "\n" . $email . "\n" . $source . "\n" . $medium . "\n" . $campaign . "\n" . $produkt);
?>
<head>
        ...
        <div class="header__contact">
            ...
            <div class="header__address">
                <img alt="" src="images/icons/location.png">
                    <span>Rīga, Lizuma iela 1 k-12 (около T/C Alfa)</span>
            </div>
            <div class="header__languages">
                <a href="order.php"><span>LV</span></a>
                <a class="active" href="order_ru.php"><span>RU</span></a>
            </div>
        </div>
    </div>
</div>
